...
class ListSandboxesRequest(_message.Message):
    ...
    workspace: str
    all_workspaces: bool
    def __init__(self, limit: _Optional[int] = ..., offset: _Optional[int] = ..., label_selector: _Optional[str] = ..., workspace: _Optional[str] = ..., all_workspaces: _Optional[bool] = ...) -> None: ...
...
class AttachSandboxProviderResponse(_message.Message):
    ...
    sandbox: Sandbox
    attached: bool
    def __init__(self, sandbox: _Optional[_Union[Sandbox, _Mapping]] = ..., attached: _Optional[bool] = ...) -> None: ...
...
class DetachSandboxProviderResponse(_message.Message):
    ...
    sandbox: Sandbox
    detached: bool
    def __init__(self, sandbox: _Optional[_Union[Sandbox, _Mapping]] = ..., detached: _Optional[bool] = ...) -> None: ...
...
class ExposeServiceRequest(_message.Message):
    ...
    domain: bool
    workspace: str
    def __init__(self, sandbox: _Optional[str] = ..., service: _Optional[str] = ..., target_port: _Optional[int] = ..., domain: _Optional[bool] = ..., workspace: _Optional[str] = ...) -> None: ...
...
class ListServicesRequest(_message.Message):
    ...
    workspace: str
    all_workspaces: bool
    def __init__(self, sandbox: _Optional[str] = ..., limit: _Optional[int] = ..., offset: _Optional[int] = ..., workspace: _Optional[str] = ..., all_workspaces: _Optional[bool] = ...) -> None: ...
...
class ServiceEndpoint(_message.Message):
    ...
    target_port: int
    domain: bool
    def __init__(self, metadata: _Optional[_Union[_datamodel_pb2.ObjectMeta, _Mapping]] = ..., sandbox_id: _Optional[str] = ..., sandbox_name: _Optional[str] = ..., service_name: _Optional[str] = ..., target_port: _Optional[int] = ..., domain: _Optional[bool] = ...) -> None: ...
...
class ExecSandboxRequest(_message.Message):
    ...
    cols: int
    rows: int
    def __init__(self, sandbox_id: _Optional[str] = ..., command: _Optional[_Iterable[str]] = ..., workdir: _Optional[str] = ..., environment: _Optional[_Mapping[str, str]] = ..., timeout_seconds: _Optional[int] = ..., stdin: _Optional[bytes] = ..., tty: _Optional[bool] = ..., cols: _Optional[int] = ..., rows: _Optional[int] = ...) -> None: ...
...
class SshSession(_message.Message):
    ...
    expires_at_ms: int
    revoked: bool
    def __init__(self, metadata: _Optional[_Union[_datamodel_pb2.ObjectMeta, _Mapping]] = ..., sandbox_id: _Optional[str] = ..., token: _Optional[str] = ..., expires_at_ms: _Optional[int] = ..., revoked: _Optional[bool] = ...) -> None: ...
...
class WatchSandboxRequest(_message.Message):
    ...
    log_min_level: str
    def __init__(self, id: _Optional[str] = ..., follow_status: _Optional[bool] = ..., follow_logs: _Optional[bool] = ..., follow_events: _Optional[bool] = ..., log_tail_lines: _Optional[int] = ..., event_tail: _Optional[int] = ..., stop_on_terminal: _Optional[bool] = ..., log_since_ms: _Optional[int] = ..., log_sources: _Optional[_Iterable[str]] = ..., log_min_level: _Optional[str] = ...) -> None: ...
...
class ListProvidersRequest(_message.Message):
    ...
    workspace: str
    all_workspaces: bool
    def __init__(self, limit: _Optional[int] = ..., offset: _Optional[int] = ..., workspace: _Optional[str] = ..., all_workspaces: _Optional[bool] = ...) -> None: ...
...
class ProviderProfileCredential(_message.Message):
    ...
    def __init__(self, name: _Optional[str] = ..., description: _Optional[str] = ..., env_vars: _Optional[_Iterable[str]] = ..., required: _Optional[bool] = ..., auth_style: _Optional[str] = ..., header_name: _Optional[str] = ..., query_param: _Optional[str] = ..., refresh: _Optional[_Union[ProviderCredentialRefresh, _Mapping]] = ..., path_template: _Optional[str] = ..., token_grant: _Optional[_Union[ProviderCredentialTokenGrant, _Mapping]] = ...) -> None: ...
...
class ProviderCredentialRefreshMaterial(_message.Message):
    ...
    required: bool
    secret: bool
    def __init__(self, name: _Optional[str] = ..., description: _Optional[str] = ..., required: _Optional[bool] = ..., secret: _Optional[bool] = ...) -> None: ...
...
class ImportProviderProfilesResponse(_message.Message):
    ...
    profiles: _containers.RepeatedCompositeFieldContainer[ProviderProfile]
    imported: bool
    def __init__(self, diagnostics: _Optional[_Iterable[_Union[ProviderProfileDiagnostic, _Mapping]]] = ..., profiles: _Optional[_Iterable[_Union[ProviderProfile, _Mapping]]] = ..., imported: _Optional[bool] = ...) -> None: ...
...
class UpdateProviderProfilesResponse(_message.Message):
    ...
    profile: ProviderProfile
    updated: bool
    def __init__(self, diagnostics: _Optional[_Iterable[_Union[ProviderProfileDiagnostic, _Mapping]]] = ..., profile: _Optional[_Union[ProviderProfile, _Mapping]] = ..., updated: _Optional[bool] = ...) -> None: ...
...
class LintProviderProfilesResponse(_message.Message):
    ...
    diagnostics: _containers.RepeatedCompositeFieldContainer[ProviderProfileDiagnostic]
    valid: bool
    def __init__(self, diagnostics: _Optional[_Iterable[_Union[ProviderProfileDiagnostic, _Mapping]]] = ..., valid: _Optional[bool] = ...) -> None: ...
...
class GetSandboxProviderEnvironmentRequest(_message.Message):
    ...
    def __init__(self, sandbox_id: _Optional[str] = ..., supports_static_credential_bindings: _Optional[bool] = ...) -> None: ...
...
class StaticCredentialBinding(_message.Message):
    __slots__ = ("endpoints", "credential_identity")
    ENDPOINTS_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, endpoints: _Optional[_Iterable[_Union[StaticCredentialEndpointBinding, _Mapping]]] = ..., credential_identity: _Optional[str] = ...) -> None: ...
...
class UpdateConfigResponse(_message.Message):
    ...
    deleted: bool
    annotations: _containers.ScalarMap[str, str]
    def __init__(self, version: _Optional[int] = ..., policy_hash: _Optional[str] = ..., settings_revision: _Optional[int] = ..., deleted: _Optional[bool] = ..., annotations: _Optional[_Mapping[str, str]] = ...) -> None: ...
...
class RelayOpenResult(_message.Message):
    ...
    success: bool
    error: str
    def __init__(self, channel_id: _Optional[str] = ..., success: _Optional[bool] = ..., error: _Optional[str] = ...) -> None: ...
...
class ApproveAllDraftChunksRequest(_message.Message):
    ...
    workspace: str
    def __init__(self, name: _Optional[str] = ..., include_security_flagged: _Optional[bool] = ..., workspace: _Optional[str] = ...) -> None: ...
