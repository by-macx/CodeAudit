...
// ScanMode 依据: proto ScanMode / 04 §3 四模式
export const SCAN_MODE: Record<string, string> = {
  SCAN_MODE_AI_ONLY: '模式A 纯AI',
  SCAN_MODE_TRADITIONAL_FIRST: '模式B SAST→AI增强（推荐）',
  SCAN_MODE_PARALLEL: '模式C 并行对比',
  SCAN_MODE_SAST_REVIEW: '模式D SAST→AI审核',
};
...
export const STAGE_TYPE: Record<string, string> = {
  ...
  STAGE_TYPE_AI_REVIEW: 'AI 审核（模式D）',
};
